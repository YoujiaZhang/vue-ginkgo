...
import about from "./my-content-s/about.vue";

export default {
  components: { myPostsList, myCommentList, myFollowerList, myFolloweeList, about },
  data() {
    return {
      tabActiveKey: ["1", "2", "3", "4", "5"],
      tabIndex: 0,
    };
  },
  methods: {
    ...
    swiperleft: function () {
      ...
      this.tabIndex = Math.min(4, this.tabIndex + 1);
    },
    tabsChange(key) {
